...
bool CodeGeneratorJava::generateCodeImpl(FILE* fd, const MetricInfoMap& metricsIds) {
    ...
    fprintf(fd, "public static void logCounterIncrement(String metricId) {\n");
    fprintf(fd, "    logCounterIncrement(metricId, 1);\n");
    fprintf(fd, "}\n\n");

    fprintf(fd, "public static void logCounterIncrement(String metricId, long amount) {\n");
