...
bool CodeGeneratorNativeHeader::generateCodeImpl(FILE* fd, const MetricInfoMap& /*metricsIds*/) {
    ...
    fprintf(fd, "class ExpressLog {\n");
    fprintf(fd, "public:\n");
    fprintf(fd, "    static void logCounterIncrement(const char* metricId, int64_t amount = 1);\n");
    fprintf(fd, "};\n\n");
...
bool CodeGeneratorNativeCpp::generateCodeImpl(FILE* fd, const MetricInfoMap& metricsIds) {
    ...
    fprintf(fd, "void ExpressLog::logCounterIncrement(const char* metricName, int64_t amount) {\n");
