...
public class CounterMetricTest {
  ...
  public void testLogValidName() {
    boolean result = true;
    try {
      ExpressLog.logIncrement("tex_test.value_telemetry_express_test_counter");
  ...
  public void testLogInvalidName() {
    boolean result = true;
    try {
      ExpressLog.logIncrement("tex_test.value_telemetry_express_test_counter2");
    } catch (IllegalArgumentException e) {
      result = false;
    }
  ...
  public void testLogInvalidType() {
    boolean result = true;
    try {
      ExpressLog.logIncrement("tex_test.value_telemetry_express_test_unknown");
