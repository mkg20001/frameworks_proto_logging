 ...
 */
TEST(CollationTest, CollateStatsExternal) {
    google::protobuf::compiler::DiskSourceTree source_tree;

    if (getenv("ANDROID_BUILD_TOP") != NULL) {
        source_tree.MapPath("", getenv("ANDROID_BUILD_TOP"));
    }
    ...
    Atoms atoms;
    int errorCount = collate_atoms(externalFileAtoms, DEFAULT_MODULE_NAME, &atoms);
