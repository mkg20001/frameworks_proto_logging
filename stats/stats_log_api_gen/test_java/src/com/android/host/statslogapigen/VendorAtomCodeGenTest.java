...
import com.android.host.statslogapigen.VendorAtomsLogModule;
...
public class VendorAtomCodeGenTest extends BaseHostJUnit4Test {
    ...
    @Test
    public void testAtomIdWithModule() throws Exception {
        assertThat(VendorAtomsLogModule.VENDOR_ATOM4).isEqualTo(105504);
        assertThat(VendorAtomsLogModule.VENDOR_ATOM4__ENUM_TYPE4__TYPE_UNKNOWN).isEqualTo(0);
        assertThat(VendorAtomsLogModule.VENDOR_ATOM4__ENUM_TYPE4__TYPE_1).isEqualTo(1);
