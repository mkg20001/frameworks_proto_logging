...
TEST(ApiGenVendorAtomTest, AtomEnumsConstantsTest) {
    ...
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_RESISTANCE, 3);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_RESISTANCE, 4);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_VOLTAGE, 5);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_VOLTAGE, 6);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_CURRENT, 7);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_CURRENT, 8);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_BATT_LEVEL, 9);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_BATT_LEVEL, 10);
    EXPECT_EQ(VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_AVG_RESISTANCE, 11);
}
