...
#include "vendor_atoms.h"

namespace android {
namespace stats_log_api_gen {

namespace HealthAtoms = hardware::google::pixel::HealthAtoms;
...
TEST(ApiGenVendorAtomTest, AtomIdConstantsTest) {
    ...
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT, 105026);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_CAUSED_SHUTDOWN, 105027);
}
...
TEST(ApiGenVendorAtomTest, AtomEnumsConstantsTest) {
    ...
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_UNKNOWN, 0);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_TEMP, 1);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_TEMP, 2);
    EXPECT_EQ(
            HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_RESISTANCE,
            3);
    EXPECT_EQ(
            HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_RESISTANCE,
            4);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_VOLTAGE,
              5);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_VOLTAGE,
              6);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_CURRENT,
              7);
    EXPECT_EQ(HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_CURRENT,
              8);
    EXPECT_EQ(
            HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MIN_BATT_LEVEL,
            9);
    EXPECT_EQ(
            HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_MAX_BATT_LEVEL,
            10);
    EXPECT_EQ(
            HealthAtoms::VENDOR_BATTERY_HEALTH_SNAPSHOT__TYPE__BATTERY_SNAPSHOT_TYPE_AVG_RESISTANCE,
            11);
}
